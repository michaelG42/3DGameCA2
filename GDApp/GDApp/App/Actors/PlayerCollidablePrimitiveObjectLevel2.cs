...
namespace GDLibrary
{
    public class PlayerCollidablePrimitiveObjectLevel2 : CollidablePrimitiveObject
    {
        #region Fields
        ...
        private PlayerCollidablePrimitiveObjectLevel2[] targets;
        ...
        public PlayerCollidablePrimitiveObjectLevel2[] Targets { get => targets; set => targets = value; }
        ...
        public PlayerCollidablePrimitiveObjectLevel2(string id, ActorType actorType, Transform3D transform, EffectParameters effectParameters,
        ...
        public PlayerCollidablePrimitiveObjectLevel2(PrimitiveObject primitiveObject, ICollisionPrimitive collisionPrimitive,
        ...
        protected override void HandleCollisionResponse(Actor collidee)
        {
            ...
            else if (collidee is CollidablePrimitiveObject)
            {
                ...
                else if (collidee.ActorType == ActorType.CollidableEnemy || collidee.ActorType == ActorType.Player)
                {
                    ...
                    (collidee as PlayerCollidablePrimitiveObjectLevel2).accelerationVector = -CalculateCollisionVector((collidee as CollidablePrimitiveObject).Velocity);
        ...
        protected void HandleAcceleration(GameTime gameTime)
        {
            ...
            this.Velocity = (CalculateVelocity()) + this.accelerationVector;//+ (this.platformVector) ;
