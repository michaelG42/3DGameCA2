...
namespace GDApp
{
    public class MainOld : Game
    {
        ...
        private void InitializeQuadPrimitives()
        {
            ...
            //get the archetype from the factory
            PrimitiveObject archetypeQuad = this.primitiveFactory.GetArchetypePrimitiveObject(graphics.GraphicsDevice, ShapeType.ColoredSphere, effectParameters);
